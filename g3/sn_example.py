...
def main():
    print(z)
    print("Ex 1 : " + str(z.getAssociations()))
    print("Ex 2 : " + str(z.getObjects()))
    print("Ex 3 : " + str(z.getUsers()))
    print("Ex 4 : " + str(z.getTypes()))
    # print("Ex 8 : " + str(z.getLocalAssocUsers(da)))
    print("Ex 9 Exemplo A: " + str(z.predecessor('vertebrado', 'socrates')))
    print("Ex 9 Exemplo B: " + str(z.predecessor('vertebrado', 'filosofo')))
    print("Ex 10: " + str(z.predecessor_path('vertebrado', 'socrates')))
    print("Ex 11: " + str(z.query('socrates', 'altura')))
    print("Ex 11B : " + str(z.query2('homem', 'mamar')))
    print("Ex 12: " + str(z.query_cancel('socrates', 'altura')))
    print("Ex 13: " + str(z.query_down('mamifero', 'altura')))
    print("Ex 14: ", z.query_induce('vertebrado', 'altura'))
